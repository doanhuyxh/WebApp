namespace WebApp.Models
{
    public class ConfigShop
    {
        ...
        public string TimeOnline { get; set; } = string.Empty;
        public string ImgSlie1 { get; set; } = string.Empty;
        ...
        public string BannerButton1 { get; set; } = string.Empty;
        public string BannerButton2 { get; set; } = string.Empty;
        public string BannerButton3 { get; set; } = string.Empty;
    }
}
